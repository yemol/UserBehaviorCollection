...
namespace UserBehaviorCollection
{
	...
	public partial class PageVisit : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Guid _PageIndentity;
    ...
    partial void OnCreated();
    partial void OnPageIndentityChanging(System.Guid value);
    partial void OnPageIndentityChanged();
    ...
    partial void OnActionsChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PageIndentity", DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true)]
		public System.Guid PageIndentity
		{
			get
			{
				return this._PageIndentity;
			}
			set
			{
				if ((this._PageIndentity != value))
				{
					this.OnPageIndentityChanging(value);
					this.SendPropertyChanging();
					this._PageIndentity = value;
					this.SendPropertyChanged("PageIndentity");
					this.OnPageIndentityChanged();
				}
			}
		}
